...
public class PlaylistSongs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameAlbum = intent.getStringExtra("playlistSong");
        int imgRes = intent.getIntExtra("imgPlaylist", 0);
        ...
        songs = dbHelper.getSongsByPlaylist(nameAlbum);
        ...
        btnHome.setOnClickListener(view -> {
            Intent myIntent = new Intent(PlaylistSongs.this, HomeActivity.class);
        ...
        btnLikeActivity.setOnClickListener(view -> {
            Intent intent1 = new Intent(PlaylistSongs.this, FavoriteSongs.class);
        ...
        btnProfileActivity.setOnClickListener(view -> {
            Intent intent2 = new Intent(PlaylistSongs.this, MyAccountActivity.class);
        ...
        btnShuffle.setOnClickListener(v -> {
            if (songs == null || songs.isEmpty()) {
                Toast.makeText(PlaylistSongs.this,
